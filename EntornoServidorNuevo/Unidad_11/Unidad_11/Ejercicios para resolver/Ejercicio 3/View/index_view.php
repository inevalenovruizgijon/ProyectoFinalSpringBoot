                    ...
                    <?php foreach ($data['productos'] as $producto): ?>
                        <tr class="producto">
                            ...
                            <?php if ($cantTemp[$producto->getId()]>0): ?>
                                    <td class="comprar"><a href="../Controller/comprarProducto.php?id=<?= $producto->getId() ?>" class="btn btn-borrar">Comprar</a></td>
                            <?php else: ?>
...
<script>
    ...
    <a href="../Controller/admin.php" class="admin-button" title="Administrar Productos">
