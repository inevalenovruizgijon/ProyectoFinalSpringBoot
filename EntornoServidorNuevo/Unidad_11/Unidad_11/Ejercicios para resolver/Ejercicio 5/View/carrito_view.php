                ...
                <?php foreach ($data['productos'] as $producto): ?>
                    <tr class="producto">
                        ...
                        <?php if ($producto[1]<$producto[0]->getStock()): ?>
                                    <td class="comprar"><a href="../Controller/comprarProducto.php?cod_producto=<?= $producto[0]->getId() ?>" class="btn btn-modificar">Comprar</a></td>
                            <?php else: ?>
                                    <td class="comprar"><a href="#" class="btn btn-modificar">Stock maximo</a></td>
                            <?php endif ?>
                        <td>
                            <a href="../Controller/eliminarProducto.php?cod_producto=<?= $producto[0]->getId() ?>" class="btn btn-borrar">
