                ...
                <tbody>
                    <?php foreach ($data['asignaturas'] as $asignatura): ?>
                        <tr class="asignatura">
                            ...
                            <td class="eliminar"><a href="../Controller/borraAsignaturaAlumno.php?codigo=<?= $asignatura->getCodigo() ?>" class="btn btn-borrar">Eliminar</a></td>
                        </tr>
                        <?php endforeach; ?>
                        <tr>
                        <td class="nuevo"><a href="../Controller/nuevoAlumnoAsignatura.php" class="btn btn-nuevo">Agregar Asignatura</a></td>
